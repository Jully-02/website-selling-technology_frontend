...
import { formatCurrency, formatDateTable, getDetailOrder } from '../../../../api/order.api';
...
const OrderDetailAdmin: React.FC<OrderDetailProps> = (props) => {
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            const response: any = await getDetailOrder(props.orderId);
            setOrder(response.data);
        }

        const fetchOrderDetail = async () => {
            const response: any = await getDetailOrderDetailByOrderId(props.orderId);
